                ...
                <div class="header-bottom-left">
                    ...
                    <div class="menu">
                        <ul class="megamenu skyblue">
                            ...
                            <li><a class="color4" href="Brand?BID=1">Giày Nike</a></li>				
                            <li><a class="color5" href="Adidas.jsp">Giày Adidas</a></li>
                            <li><a class="color6" href="Mizuno.jsp">Giày Mizuno</a></li>
                            <li><a class="color7" href="Kamito.jsp">Giày Kamito</a></li>
                        </ul>
                    </div>
                </div>
